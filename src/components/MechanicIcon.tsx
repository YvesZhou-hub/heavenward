...
export function MechanicIcon({id,size=16}:{id:string;size?:number}){const Icon=icons[id as keyof typeof icons]??CircleDot;return <Icon size={size} strokeWidth={1.6} aria-hidden="true"/>;}
